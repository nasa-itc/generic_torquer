...
void Test_GENERIC_TORQUER_AppMain(void) {
  ...
  UT_CheckEvent_Setup(&EventTest, GENERIC_TORQUER_PIPE_ERR_EID,
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_TORQUER_PIPE_ERR_EID generated (%u)",
...
void Test_GENERIC_TORQUER_ProcessCommandPacket(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_TORQUER_CMD_ERR_EID not generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_TORQUER_ProcessCommandPacket();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_TORQUER_CMD_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
...
void Test_GENERIC_TORQUER_ProcessGroundCommand(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_TORQUER_CMD_NOOP_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_TORQUER_ProcessGroundCommand();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_TORQUER_CMD_RESET_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
...
void Test_GENERIC_TORQUER_ReportHousekeeping(void) {
  ...
  UtAssert_True(MsgSend ==
                    &GENERIC_TORQUER_AppData.HkTelemetryPkt.TlmHeader.Msg,
...
void Test_GENERIC_TORQUER_VerifyCmdLength(void) {
   ...
   */
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_TORQUER_LEN_ERR_EID NOT generated (%u)",
                (unsigned int)EventTest.MatchCount);
   ...
   */
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_TORQUER_LEN_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
 ...
 */
void Generic_torquer_UT_Setup(void) { UT_ResetState(0); }
