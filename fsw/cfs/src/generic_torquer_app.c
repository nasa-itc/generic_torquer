      ...
      if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
        ...
        if (percent_cmd_ptr->TrqNum <= 2) {
          status = GENERIC_TORQUER_Config(
              &GENERIC_TORQUER_AppData.HkTelemetryPkt
                   .TrqInfo[percent_cmd_ptr->TrqNum],
              &GENERIC_TORQUER_AppData.trqDevice[percent_cmd_ptr->TrqNum],
              percent_cmd_ptr->PercentOn, percent_cmd_ptr->Direction);
      ...
      if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
        ...
        GENERIC_TORQUER_All_Percent_On_cmd_t *all_percent_cmd_ptr =
            (GENERIC_TORQUER_All_Percent_On_cmd_t *)
                GENERIC_TORQUER_AppData.MsgPtr;
        status += GENERIC_TORQUER_Config(
            &GENERIC_TORQUER_AppData.HkTelemetryPkt.TrqInfo[0],
            &GENERIC_TORQUER_AppData.trqDevice[0],
            all_percent_cmd_ptr->PercentOn_0, all_percent_cmd_ptr->Direction_1);
        status += GENERIC_TORQUER_Config(
            &GENERIC_TORQUER_AppData.HkTelemetryPkt.TrqInfo[1],
            &GENERIC_TORQUER_AppData.trqDevice[1],
            all_percent_cmd_ptr->Direction_1, all_percent_cmd_ptr->PercentOn_1);
        status += GENERIC_TORQUER_Config(
            &GENERIC_TORQUER_AppData.HkTelemetryPkt.TrqInfo[2],
            &GENERIC_TORQUER_AppData.trqDevice[2],
