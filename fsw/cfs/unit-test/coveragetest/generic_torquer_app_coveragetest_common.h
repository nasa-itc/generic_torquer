 ...
 * @file
 *
 * Common definitions for all generic_torquer_app coverage tests
 */

#ifndef GENERIC_TORQUER_APP_COVERAGETEST_COMMON_H
#define GENERIC_TORQUER_APP_COVERAGETEST_COMMON_H
...
#define ADD_TEST(test)                                                         \
  UtTest_Add((Test_##test), Generic_torquer_UT_Setup,                          \
             Generic_torquer_UT_TearDown, #test)
...
#endif /* GENERIC_TORQUER_APP_COVERAGETEST_COMMON_H */
