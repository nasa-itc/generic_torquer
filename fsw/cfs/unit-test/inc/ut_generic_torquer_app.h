 ...
 *
 * Purpose:
 * Extra scaffolding functions for the generic_torquer_app unit test
 *
 * Notes:
...
#ifndef UT_GENERIC_TORQUER_APP_H
#define UT_GENERIC_TORQUER_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "GENERIC_TORQUER_APP_Data_t" typedef.
 */
