...
void TORQUER_AppMain(void) {
  ...
  while (CFE_ES_RunLoop(&GENERIC_TORQUER_AppData.RunStatus) == true) {
    ...
    */
    status = CFE_SB_ReceiveBuffer(
        (CFE_SB_Buffer_t **)&GENERIC_TORQUER_AppData.MsgPtr,
    ...
    */
    if (status == CFE_SUCCESS) {
      ...
      CFE_EVS_SendEvent(GENERIC_TORQUER_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_TORQUER: SB Pipe Read Error = %d",
                        (int)status);
      GENERIC_TORQUER_AppData.RunStatus = CFE_ES_RunStatus_APP_ERROR;
    }
  }
  ...
  */
  ...
  trq_close(&GENERIC_TORQUER_AppData
                 .trqDevice[0]); /* TODO: Move this into disable when close
                                    issue resolved in HWLIB */
...
int32 GENERIC_TORQUER_AppInit(void) {
  ...
  */
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_TORQUER: Error registering for event services: 0x%08X\n",
        (unsigned int)status);
    return status;
  }
  ...
  */
  status = CFE_SB_CreatePipe(&GENERIC_TORQUER_AppData.CmdPipe,
                             GENERIC_TORQUER_PIPE_DEPTH, "GENERIC_TRQ_PIPE");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_TORQUER_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_TORQUER_CMD_MID),
                            GENERIC_TORQUER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_TORQUER_REQ_HK_MID),
                            GENERIC_TORQUER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_TORQUER_SUB_REQ_HK_ERR_EID,
  ...
  ** telemetry that has been defined in the GENERIC_TORQUER_HkTelemetryPkt for
  *this app.
  */
  ...
  *block
  */
  GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled =
      GENERIC_TORQUER_DEVICE_DISABLED;

  /*
  ** Initialize torquer interfaces
  */
  GENERIC_TORQUER_AppData.HkTelemetryPkt.TorquerPeriod =
      GENERIC_TORQUER_CFG_PERIOD;
  for (uint8_t i = 0; i < 3; i++) {
    ...
    GENERIC_TORQUER_AppData.trqDevice[i].timer_period_ns =
        GENERIC_TORQUER_CFG_PERIOD;
    ...
    trq_init(
        &GENERIC_TORQUER_AppData.trqDevice[i]); /* TODO: Move this into enable
                                                   once HWLIB issue resolved */
  }
  ...
  status = CFE_EVS_SendEvent(
      GENERIC_TORQUER_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
      "GENERIC_TORQUER App Initialized. Version %d.%d.%d.%d",
      GENERIC_TORQUER_MAJOR_VERSION, GENERIC_TORQUER_MINOR_VERSION,
      GENERIC_TORQUER_REVISION, GENERIC_TORQUER_MISSION_REV);
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_TORQUER: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
void GENERIC_TORQUER_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the GENERIC_TORQUER_CMD_MID
  *(Message ID)
  */
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_TORQUER_PROCESS_CMD_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "GENERIC_TORQUER: Invalid command packet, MID = 0x%x",
...
void GENERIC_TORQUER_ProcessGroundCommand(void) {
  ...
  case GENERIC_TORQUER_NOOP_CC:
    ...
    */
    if (GENERIC_TORQUER_VerifyCmdLength(GENERIC_TORQUER_AppData.MsgPtr,
                                        sizeof(GENERIC_TORQUER_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_NOOP_INF_EID,
  ...
  */
  case GENERIC_TORQUER_RESET_COUNTERS_CC:
    if (GENERIC_TORQUER_VerifyCmdLength(GENERIC_TORQUER_AppData.MsgPtr,
                                        sizeof(GENERIC_TORQUER_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_RESET_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_TORQUER_ENABLE_CC:
    if (GENERIC_TORQUER_VerifyCmdLength(GENERIC_TORQUER_AppData.MsgPtr,
                                        sizeof(GENERIC_TORQUER_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_TORQUER_DISABLE_CC:
    if (GENERIC_TORQUER_VerifyCmdLength(GENERIC_TORQUER_AppData.MsgPtr,
                                        sizeof(GENERIC_TORQUER_NoArgs_cmd_t)) ==
        OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_TORQUER_CONFIG_CC:
    if (GENERIC_TORQUER_VerifyCmdLength(
            GENERIC_TORQUER_AppData.MsgPtr,
            sizeof(GENERIC_TORQUER_Percent_On_cmd_t)) == OS_SUCCESS) {
      // CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_CONFIG_INF_EID,
      // CFE_EVS_EventType_INFORMATION, "GENERIC_TORQUER: Configuration command
      // received");
  ...
  */
  case GENERIC_TORQUER_CONFIG_ALL_CC:
    if (GENERIC_TORQUER_VerifyCmdLength(
      ...
      // CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_CONFIG_ALL_INF_EID,
      // CFE_EVS_EventType_INFORMATION, "GENERIC_TORQUER: Configuration command
      // received");
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_TORQUER_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "GENERIC_TORQUER: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
...
void GENERIC_TORQUER_ProcessTelemetryRequest(void) {
  ...
  */
  default:
    /* Increment the error counter upon receipt of an invalid command */
    GENERIC_TORQUER_AppData.HkTelemetryPkt.CommandErrorCount++;
    CFE_EVS_SendEvent(GENERIC_TORQUER_DEVICE_TLM_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "GENERIC_TORQUER: Invalid command code for packet, MID = "
                      "0x%x, cmdCode = 0x%x",
                      CFE_SB_MsgIdToValue(MsgId), CommandCode);
...
void GENERIC_TORQUER_ReportHousekeeping(void) {
  ...
  CFE_SB_TimeStampMsg(
      (CFE_MSG_Message_t *)&GENERIC_TORQUER_AppData.HkTelemetryPkt);
  CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&GENERIC_TORQUER_AppData.HkTelemetryPkt, true);
  return;
}
...
void GENERIC_TORQUER_Enable(void) {
  ...
  if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_TORQUER_DEVICE_DISABLED) {
    /*
    ...
    */
    ...
    if (status == OS_SUCCESS) {
      GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceCount++;
      GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled =
          GENERIC_TORQUER_DEVICE_ENABLED;
      CFE_EVS_SendEvent(GENERIC_TORQUER_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "GENERIC_TORQUER: Device enabled");
    } else {
      GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(GENERIC_TORQUER_INIT_ERR_EID, CFE_EVS_EventType_ERROR,
                        "GENERIC_TORQUER: Torquer initialization error %d",
                        status);
    }
  } else {
    GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceErrorCount++;
...
void GENERIC_TORQUER_Disable(void) {
  ...
  if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled =
        GENERIC_TORQUER_DEVICE_DISABLED;
    CFE_EVS_SendEvent(GENERIC_TORQUER_DISABLE_INF_EID,
                      CFE_EVS_EventType_INFORMATION,
                      "GENERIC_TORQUER: Device disabled");
  } else {
    GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(
        GENERIC_TORQUER_DISABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
int32 GENERIC_TORQUER_Config(uint8 num, uint8 percent, uint8 dir) {
  ...
  if (status == OS_SUCCESS) {
    ...
    GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(GENERIC_TORQUER_CONFIG_ERR_EID,
                      CFE_EVS_EventType_INFORMATION,
                      "GENERIC_TORQUER: Failed to configure device %d", num);
  }
  return status;
}
...
int32 GENERIC_TORQUER_PercentOn(CFE_MSG_Message_t *msg) {
  ...
  GENERIC_TORQUER_Percent_On_cmd_t *percent_cmd_ptr =
      (GENERIC_TORQUER_Percent_On_cmd_t *)msg;

  /* Check that device is enabled */
  if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_TORQUER_DEVICE_ENABLED) {
    GENERIC_TORQUER_Config(percent_cmd_ptr->TrqNum, percent_cmd_ptr->PercentOn,
...
int32 GENERIC_TORQUER_AllPercentOn(CFE_MSG_Message_t *msg) {
  ...
  GENERIC_TORQUER_All_Percent_On_cmd_t *all_percent_cmd_ptr =
      (GENERIC_TORQUER_All_Percent_On_cmd_t *)msg;

  /* Check that device is enabled */
  if (GENERIC_TORQUER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_TORQUER_DEVICE_ENABLED) {
    GENERIC_TORQUER_Config(0, all_percent_cmd_ptr->PercentOn_0,
                           all_percent_cmd_ptr->Direction_0);
    GENERIC_TORQUER_Config(1, all_percent_cmd_ptr->PercentOn_1,
                           all_percent_cmd_ptr->Direction_1);
    GENERIC_TORQUER_Config(2, all_percent_cmd_ptr->PercentOn_2,
                           all_percent_cmd_ptr->Direction_2);
  }
  return status;
}
...
*/
int32 GENERIC_TORQUER_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        GENERIC_TORQUER_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
