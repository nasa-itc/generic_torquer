...
#define GENERIC_TORQUER_PERCENT_ON_CMD_LEN                                     \
  sizeof(GENERIC_TORQUER_Percent_On_cmd_t)
...
#define GENERIC_TORQUER_ALL_PERCENT_ON_CMD_LEN                                 \
  sizeof(GENERIC_TORQUER_All_Percent_On_cmd_t)
