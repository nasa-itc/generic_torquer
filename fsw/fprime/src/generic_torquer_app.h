...
** This struct is defined in the `generic_torquer_app.h` file with one global
*instance
** in the `.c` file.
*/
typedef struct {
  ...
  */
  GENERIC_TORQUER_Hk_tlm_t
      HkTelemetryPkt; /* GENERIC_TORQUER Housekeeping Telemetry Packet */
...
*/
extern GENERIC_TORQUER_AppData_t
    GENERIC_TORQUER_AppData; /* GENERIC_TORQUER App Data */
